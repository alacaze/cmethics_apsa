...
There are three key components of the framework: principle-based ethics provides the theoretical foundations, a *public health argument* provides *prima facie* support for the sale of complementary medicines in community pharmacy, and specific responsibilities are provided that ensure that pharmacists meet their obligations to the public when selling complementary medicines.
...
The theory provides resources for how to go about further specifying these general principles when they conflict in particular contexts.
The approach---using *reflective equilibrium* and *specification*---provides a framework for responding to ethical challenges in a particular context by explicitly weighing up and resolving conflicts in general principles based on salient details within the context [REF].

The specific responsibilities provided by the framework were developed by weighing up mid-level principles such as the need for pharmacists to provide evidence-based care as well as respect the health beliefs and preferences of consumers.
These mid-level principles can be derived from higher-order guiding principles, such as ensuring positive health outcomes in consumers (beneficence and non-maleficence) and respecting autonomy.
...
Pharmacists have excellent general skills in being able to identify and resolve possible drug interactions and to provide guidance regarding actual or potential adverse reactions.
...
The framework suggests that *recommendations* for a complementary medicine must be consistent with current best evidence, and the *sale* of a complementary medicine (without recommendation) should be accompanied with the *offer* of advice from a pharmacist.
...
A number of strategies were employed to support the success of conducting the focus group in an online environment, these included ensuring the groups did not get too large, enabling video feeds and offering alternatives for those with lower internet speeds [@Gaiser2017].
<!-- NOTE: how? -->
...
All focus groups and interviews were conducted by AL who has experience in qualitative research, facilitation of online groups and ethical reasoning and discussion-making in pharmacy practice.
...
AL and ASP debriefed immediately following each focus group and interview and prepared the summary that was sent to participants.

The workshops and interviews were video and audio recorded. 
Participants received a summary of the workshop or interview discussion and were
...
Understanding these themes, and the ways in which participants varied within the themes provide insight into the *context* (\ref{context}) of community pharmacy practice in relation to complementary medicines, and the *acceptability* and *feasibility* of the framework as perceived by the participants.
...
These participants are less likely to initiate discussion of complementary medicines with consumers, more likely to express a lack of confidence in complementary medicines and tended to rely more heavily on support staff in this area.
...
These participants put more significantly more weight into anecdotal reports and placebo effects as providing evidence for the effectiveness of complementary medicines.
In response to the explicit PSA guidance to only sell complementary medicines that are "effective", one participant felt that placebo effects were sufficient to meet this standard.
...
Participants tended to vary according to their approach to complementary medicines and approach to evidence independently (as well as their perceptions of their colleagues approach to complementary medicines and approach to evidence).
