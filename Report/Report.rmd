...
However, for the argument to be compelling pharmacists and pharmacy support staff need to be proactive in providing evidence-based advice to consumers.
This is not always the case.
Some pharmacists are hesitant to discuss complementary medicines with consumers, and some provide inaccurate or misleading information regarding the likely benefits of complementary medicines [@SalmanPopattia2018;@Arnold2016;@Bray2017].
...
ASP has a background in nursing and bioethics and developed the ethical framework as part of PhD.
...
![Results of the presurvey. Statements are ordered by the percentage of agreement of the participants.](fig_tab/presurvey.png)
...
It balances pharmacist responsibilities to providing evidence-based health care, to promote positive health outcomes and to respect consumer health beliefs and preferences.
...
It also needs to be noted that the study did not include consumers or pharmacy support staff.
However, the perspectives of these groups have been explored elsewhere [@Iyer2016a].
...
Several participants indicated that guidance on the availability, strengths and limitations of key evidence-based information resources on complementary medicines would provide help them to implement the framework.
The confidence and comfort of participants who identified an evidence-based and proactive approach to complementary medicines  "Evidence-based" participants who adopted a proactive approach to complementary medicines 

Recommendations:

* Move participants towards the upper right quadrant ("EBP", "proactive")
