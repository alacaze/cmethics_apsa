...
\bigskip
__Document__: `r system("git rev-parse --short HEAD", intern = TRUE)` (git commit; [repository](https://github.com/alacaze/cmethics_apsa)) \hfill `r format(Sys.time(), '%d %B, %Y')`
...
Within focus groups this view was directly challenged by other participants who felt that it was important for pharmacies to compete on services and cost rather than cost alone.
...
Participants who were "proactive" and "evidence-based" were most strongly in favour of the proposed ethical framework.
...
Some of the considerations include the availability of well-conducted randomized trials, the lack of impetus for such trials given the 
